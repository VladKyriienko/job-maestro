...
drop policy "Public read access" on "public"."TypeOfVacancy";

revoke delete on table "public"."TypeOfVacancy" from "anon";

revoke insert on table "public"."TypeOfVacancy" from "anon";

revoke references on table "public"."TypeOfVacancy" from "anon";

revoke select on table "public"."TypeOfVacancy" from "anon";

revoke trigger on table "public"."TypeOfVacancy" from "anon";

revoke truncate on table "public"."TypeOfVacancy" from "anon";

revoke update on table "public"."TypeOfVacancy" from "anon";

revoke delete on table "public"."TypeOfVacancy" from "authenticated";

revoke insert on table "public"."TypeOfVacancy" from "authenticated";

revoke references on table "public"."TypeOfVacancy" from "authenticated";

revoke select on table "public"."TypeOfVacancy" from "authenticated";

revoke trigger on table "public"."TypeOfVacancy" from "authenticated";

revoke truncate on table "public"."TypeOfVacancy" from "authenticated";

revoke update on table "public"."TypeOfVacancy" from "authenticated";

revoke delete on table "public"."TypeOfVacancy" from "service_role";

revoke insert on table "public"."TypeOfVacancy" from "service_role";

revoke references on table "public"."TypeOfVacancy" from "service_role";

revoke select on table "public"."TypeOfVacancy" from "service_role";

revoke trigger on table "public"."TypeOfVacancy" from "service_role";

revoke truncate on table "public"."TypeOfVacancy" from "service_role";

revoke update on table "public"."TypeOfVacancy" from "service_role";

alter table "public"."TypeOfVacancy" drop constraint "TypeOfVacancy_pkey";

drop index if exists "public"."TypeOfVacancy_pkey";

drop table "public"."TypeOfVacancy";
